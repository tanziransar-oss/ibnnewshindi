...
export default function LoginPage() {
  ...
  const t = {
    title: languageMode === "hi" ? "लॉग इन / साइन अप" : "Login or Sign Up",
    subtitle:
      languageMode === "hi"
        ? "सुरक्षित और त्वरित लॉगिन के लिए अपने गूगल अकाउंट का उपयोग करें।"
        : "Use your Google account for a secure, single-tap authentication experience.",
    googleButton:
      languageMode === "hi" ? "गूगल के साथ जारी रखें" : "Continue with Google",
    loading: languageMode === "hi" ? "रीडायरेक्ट किया जा रहा है..." : "Redirecting to Google...",
    securityNotice:
      languageMode === "hi"
        ? "हम आपकी गोपनीयता का सम्मान करते हैं। पासवर्ड रहित सुरक्षित पहुंच।"
        : "We value your privacy. Passwordless security managed via Google OAuth.",
    footerDisclaimer:
      languageMode === "hi"
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 items-center justify-center px-4 py-16">
        <section className="w-full max-w-md rounded-2xl border border-[var(--border-color)] bg-white p-6 shadow-sm md:p-8">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-zinc-50 border border-zinc-100 text-lg font-black text-[var(--news-red)]">
              IBN
            </div>
